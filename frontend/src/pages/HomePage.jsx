...
export default function HomePage() {
    ...
    useEffect(() => {
        axios.get('http://localhost:3000/projects/')
          .then(response => {
            setProjects(response.data.data); // Access data from 'data' in the response
          })
        ...
        <div className="main-container w-[1440px] h-[869px] bg-[#003049] relative overflow-hidden mx-auto my-0">
            ...
            <div className="w-[1140px] h-[590px] bg-[#d9d9d9] rounded-[25px] relative z-[11] mt-[30px] mr-0 mb-0 ml-[150px] overflow-y-auto">
                ...
                <div className="w-full flex justify-end p-4">
                    <Link to="/create">
                        <button className="w-[200px] h-[60px] bg-[#780000] rounded-[25px] border-none text-[#d9d9d9] font-['Poppins'] text-[20px] font-medium leading-[48px]">
                            Create Project
                        </button>
                    </Link>
                </div>
